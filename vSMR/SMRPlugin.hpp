...
#define MY_PLUGIN_VERSION   "v1.6.3"
#define MY_PLUGIN_DEVELOPER "Pierre Ferran, Even Rognlien, Lionel Bischof, Daniel Lange, Juha Holopainen, Keanu Czirjak, Alice Ford, Ben Walker"
